...
public partial class MilitaryPersonnelContext : IdentityDbContext<IdentityUser, IdentityRole, string>
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=localhost\\SQLEXPRESS;Initial Catalog=MilitaryPersonnelAIS;TrustServerCertificate=True;Integrated Security=True");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Simplified non-Identity configurations (only key definitions)
        ...
        modelBuilder.Entity<DocumentAssignments>(entity =>
        {
            ...
            entity.HasOne(d => d.Servicemen).WithMany(p => p.DocumentAssignments)
        ...
        modelBuilder.Entity<DocumentFlow>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedBy).WithMany(p => p.DocumentFlow)
